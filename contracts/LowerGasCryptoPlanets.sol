...
// Study how NFT give aways work so I wouldn't have to pay the fee to transfer an NFT
// Later on study how this would work if the contract was deployed to polygon

contract CrytpoPlanetsGasOptimized is ERC721, Ownable { // check on IERC721
